...
// DONE: implement support for multiline comment
...
public class Scanner {
    ...
    static {
        ...
        keywords.put("return", TokenType.RET);
        ...
        switch (c) {
            ...
            case '/':
                if (match('/')) {
                    ...
                    System.out.println("begin multiline comment");
                    multiline();
                } else {
    ...
    // overload for token with literal values
